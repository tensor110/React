...
export const MuiButton = () => {
  ...
  return (
    <div>
      ...
      <Stack direction='row'>
        <ToggleButtonGroup aria-label='text formating' value={formats} onChange={handleFormatChange} size='small' color='success' exclusive>
          {/* exclusive is for selecting one button only */}
